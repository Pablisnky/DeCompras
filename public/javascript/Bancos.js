function SeleccionarBanco(form){   

//     var Bancos = form.bancoPagoMovil.options;//se captura el elemento select que contiene los bancos
//  alert(Bancos)
//     if(Bancos[0].selected == true){//Lara
//         Municipio[0] = new Option("Seleccione municipio");
//     }
//     if(Bancos[1].selected == true){//Lara
//         Municipio[0] = new Option("Seleccione municipio");
...
//     }
//     if(Bancos[2].selected == true){//Yaracuy tien la posicion 23 en el array del select estado
//         Municipio[0] = new Option("Seleccione municipio");
