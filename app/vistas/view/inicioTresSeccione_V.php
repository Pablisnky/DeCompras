    ...
    <section class="section__main" id="Seccion_Main">
        <section class="section_1 section_1--vh borrar" id="Section_1" style="background-image: url('<?php echo RUTA_URL?>/public/images/Portada.jpg');">
        ...
        <section class="section_1 section_1--vh borrar" id="Section_1" style="background-image: url('<?php echo RUTA_URL?>/public/images/Portada_2.jpg');">
            <div class="section_1__div">
                <div class="section_1__div1">
                    <p class="section_1__p">Si tus clientes estan ocupados,</p>
                    <p class="section_1__p"><span class="span_22">¡ Ofreceles un <br class="br_2"> Servicio Premium ! </span><br> despacho en casa</p>
                </div>
        ...
        <section class="section_1 section_1--vh borrar" id="Section_1" style="background-image: url('<?php echo RUTA_URL?>/public/images/Portada_3.jpg');">
            <div class="section_1__div">
                <div class="section_1__div1">
                    <p class="section_1__p"><span class="span_22 font--negro">control administrativo <br class="br_2">de tu tienda</span></p>  
                    <div style="height: 50px;">            
                    <div class="slider" style="top: 45%; margin-left: 13%; width:80%; text-align: center">
                        <ul>
