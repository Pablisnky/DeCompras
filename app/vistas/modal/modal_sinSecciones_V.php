<?php require(RUTA_APP . "/vistas/inc/header.php");  ?>
        <section class="section_4 section_10"  id="Ejemplo_Secciones">
            <div class="contenedor_24 contenedor_118">
                    <p class="p_6">Antes de cargar productos, debes configurar completamente tu tienda, ve a "Configuración" y carga la información necesaria para que el publico pueda acceder a tu tienda.</p>
